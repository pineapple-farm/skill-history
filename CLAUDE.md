...
**YOU ARE IN: `skill_history/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/skill_history/` (rig root) or other directories
...
**Your mail address:** `skill_history/polecats/furiosa`
**Your rig:** skill_history
**Your Witness:** `skill_history/witness`
...
| Ask Witness for help | `gt mail send skill_history/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`skill_history/witness`) when:
...
```bash
gt mail send skill_history/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
